...
class EmailActionInitiatorTest {
    ...
    @BeforeEach
    void setUp() {
        player = Player.builder().email("test@mail.com").build();
    ...
    class InitiateAccountActivationTests {
        @Test
        void initiateAccountActivation_generatesTokenAndSendsEmail() {
    ...
    class InitiatePasswordResetTests {
        @Test
        void initiatePasswordReset_userExists_generatesTokenAndSendsEmail() {
    ...
    class InitiateAccountDeletionTests {
        @Test
        void initiateAccountDeletion_generatesTokenAndSendsEmail() {
            when(emailConfig.otpExpiration()).thenReturn(Duration.ofMinutes(15));
